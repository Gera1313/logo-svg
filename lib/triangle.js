...
class Triangle extends Shape {
    ...
    render() {
        ...
        <polygon points="${triangleX - this.sideLength / 2},${triangleY + this.sideLength / 2} ${triangleX},${triangleY - this.sideLength / 2} ${triangleX + this.sideLength / 2},${triangleY + this.sideLength / 2}" fill="${this.color}" />
