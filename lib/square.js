...
class Square extends Shape {
    ...
    render() {
        ...
        return `<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}"><rect x="${rectX}" y="${rectY}" width="${this.sideLength}" height="${this.sideLength}" fill="${this.color}" /><text x="50" y="180" fill="${this.textColor}" font-size="20">${this.text}</text></svg>`;
    }
}
